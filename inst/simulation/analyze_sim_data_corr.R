...
inactive.constnp.pval <- readRDS("sim_inactive_constnp_corr_pval_data.rds")
inactive.mixed.pval <- readRDS("sim_inactive_mixed_corr_pval_data.rds")
active.constnp.pval <- readRDS("sim_active_constnp_corr_pval_data.rds")
active.mixed.pval <- readRDS("sim_active_mixed_corr_pval_data.rds")
...
fdr.wide <- calc_FDR(adjp.all.df, adjp.threshold = 0.05,
                     methods = c("sumLimma_bh",
                                 "robRegLimma_bh",
                                 "pepSetTestEqCorrMAD_by",
                                 "pepSetTestEqCorrMAD_bh",
                                 "pepSetTestEqCorrSD_by",
                                 "pepSetTestEqCorrSD_bh",
                                 "pepSetTestUneqCorr_by",
                                 "pepSetTestUneqCorr_bh",
                                 "scPepSetTest_bh"))
  ...
  mutate(nTestPep = factor(nTestPep),
         ...
         method = factor(method, 
                         levels = c("sumLimma_bh_fdr",
                                    "robRegLimma_bh_fdr",
                                    "pepSetTestEqCorrMAD_by_fdr",
                                    "pepSetTestEqCorrMAD_bh_fdr",
                                    "pepSetTestEqCorrSD_by_fdr",
                                    "pepSetTestEqCorrSD_bh_fdr",
                                    "pepSetTestUneqCorr_by_fdr",
                                    "pepSetTestUneqCorr_bh_fdr",
                                    "scPepSetTest_bh_fdr")))
  ...
  mutate(nTestPep = factor(nTestPep),
         ...
         method = factor(method, 
                         levels = c("sumLimma_bh_tpr",
                                    "robRegLimma_bh_tpr",
                                    "pepSetTestEqCorrMAD_by_tpr",
                                    "pepSetTestEqCorrMAD_bh_tpr",
                                    "pepSetTestEqCorrSD_by_tpr",
                                    "pepSetTestEqCorrSD_bh_tpr",
                                    "pepSetTestUneqCorr_by_tpr",
                                    "pepSetTestUneqCorr_bh_tpr",
                                    "scPepSetTest_bh_tpr")))
